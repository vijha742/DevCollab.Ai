...
export default function LoginPage() {
    ...
    const handleGitHubLogin = () => {
        ...
        const scope = 'read:user user:email'; // Request both user info and email access
            ...
            <div className="max-w-md w-full">
                <div className="bg-white rounded-2xl shadow-xl p-8 space-y-6">
                    ...
                    <div className="text-center">
                        ...
                        <p className="text-gray-600">Sign in to continue to DevCollab</p>
                    </div>
                ...
                <div className="mt-6 text-center text-sm text-gray-600 bg-blue-50 rounded-lg p-4">
                    <p className="font-medium mb-1">🔐 Note about GitHub Login:</p>
                    <p>We'll try to access your email from GitHub. If it's not public, we'll use your username instead.</p>
                </div>
            </div>
        </div>
    );
